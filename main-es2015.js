...
/* harmony default export */ __webpack_exports__["default"] = ("<div [ngClass]=\"{'dark-theme': isDarkTheme}\" class=\"container\">\r\n    <div class=\"mat-app-background\">\r\n        <app-top-bar (toogleDarkThemeEvent)=\"changeTheme($event)\"></app-top-bar>\r\n        <router-outlet></router-outlet>\r\n    </div>\r\n</div>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<h1 mat-dialog-title>{{data}}</h1>\r\n<div mat-dialog-actions>\r\n    <button mat-button (click)=\"onOKClick()\">OK</button>\r\n</div>");
...
/* harmony import */ var _favorites_list_favorites_list_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./favorites-list/favorites-list.component */ "./src/app/favorites-list/favorites-list.component.ts");
...
const routes = [
    ...
    { path: 'home', component: _home_home__WEBPACK_IMPORTED_MODULE_4__["HomeComponent"] },
    { path: 'home/:id/:name', component: _home_home__WEBPACK_IMPORTED_MODULE_4__["HomeComponent"] },
    { path: 'favorites', component: _favorites_list_favorites_list_component__WEBPACK_IMPORTED_MODULE_5__["FavoritesListComponent"] },
    { path: '**', component: _page_not_found_page_not_found_component__WEBPACK_IMPORTED_MODULE_6__["PageNotFoundComponent"] }
];
const appRouting = _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forRoot(routes);
...
/* harmony import */ var _favorites_list_favorites_list_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./favorites-list/favorites-list.component */ "./src/app/favorites-list/favorites-list.component.ts");
...
/* harmony import */ var _store_fav_reducer__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./store/fav.reducer */ "./src/app/store/fav.reducer.ts");
...
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm2015/store.js");
/* harmony import */ var _error_dialg_error_dialg_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./error-dialg/error-dialg.component */ "./src/app/error-dialg/error-dialg.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _favorites_list_favorites_list_component__WEBPACK_IMPORTED_MODULE_4__["FavoritesListComponent"],
            ...
            _error_dialg_error_dialg_component__WEBPACK_IMPORTED_MODULE_25__["ErrorDialg"]
        ],
        entryComponents: [
            _error_dialg_error_dialg_component__WEBPACK_IMPORTED_MODULE_25__["ErrorDialg"]
        ],
        imports: [
            ...
            _ngrx_store__WEBPACK_IMPORTED_MODULE_24__["StoreModule"].forRoot({ fav: _store_fav_reducer__WEBPACK_IMPORTED_MODULE_20__["favReducer"] })
        ],
        providers: [],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ErrorDialg", function() { return ErrorDialg; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let ErrorDialg = class ErrorDialg {
...
ErrorDialg = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-error-dialg',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./error-dialg.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/error-dialg/error-dialg.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./error-dialg.component.scss */ "./src/app/error-dialg/error-dialg.component.scss")).default]
    }),
...
let FavoritesListComponent = class FavoritesListComponent {
    constructor(store) {
        this.store = store;
        this.fav = [];
        let obj;
...
FavoritesListComponent.ctorParameters = () => [
    { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_2__["Store"] }
];
FavoritesListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-favorites-list',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./favorites-list.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/favorites-list/favorites-list.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./favorites-list.component.scss */ "./src/app/favorites-list/favorites-list.component.scss")).default]
    })
...
/* harmony import */ var _store_fav_actions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../store/fav.actions */ "./src/app/store/fav.actions.ts");
...
/* harmony import */ var _error_dialg_error_dialg_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../error-dialg/error-dialg.component */ "./src/app/error-dialg/error-dialg.component.ts");
...
let HomeComponent = class HomeComponent {
    constructor(rest, route, store, formBuilder, dialog) {
        this.rest = rest;
        this.route = route;
        this.store = store;
        ...
        this.emptyForecast = { day: '', temCelsius: '', temFahrenheit: '' };
...
let RestService = class RestService {
    ...
    getAutocomplete(city) {
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            ...
            .set('q', city);
        return this.http.get(`${this.url}locations/v1/cities/autocomplete`, { params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), // retry a failed request up to 1 times
    ...
    getCurrentConditions(locationKey) {
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('apikey', this.apiKey);
        return this.http.get(`${this.url}currentconditions/v1/${locationKey}`, { params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), // retry a failed request up to 1 times
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError) // then handle the error    
        );
    }
    getForecasts(locationKey, metric) {
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('apikey', this.apiKey)
            .set('metric', metric);
        return this.http.get(`${this.url}forecasts/v1/daily/5day/${locationKey}`, { params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), // retry a failed request up to 1 times
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError) // then handle the error    
        );
    }
    getGeopositionByCoords(coords) {
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('apikey', this.apiKey)
            .set('q', coords);
        return this.http.get(`${this.url}locations/v1/cities/geoposition/search`, { params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), // retry a failed request up to 1 times
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError) // then handle the error    
        );
    }
};
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RemoveFromFav", function() { return RemoveFromFav; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _fav_actions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./fav.actions */ "./src/app/store/fav.actions.ts");
...
function favReducer(state = initialState, action) {
    switch (action.type) {
        case _fav_actions__WEBPACK_IMPORTED_MODULE_1__["ActionTypes"].Add:
            return Object.assign({}, state, { fav: [...state.fav, action.payload] });
        case _fav_actions__WEBPACK_IMPORTED_MODULE_1__["ActionTypes"].Remove:
            return Object.assign({}, state, { fav: [...state.fav.filter(item => item.id !== action.payload.id)] });
        default:
            return state;
    }
}
...
], TopBarComponent.prototype, "toogleDarkThemeEvent", void 0);
...
module.exports = __webpack_require__(/*! C:\Users\kli\neta-kleman-1-1-20\weather-app\src\main.ts */"./src/main.ts");
